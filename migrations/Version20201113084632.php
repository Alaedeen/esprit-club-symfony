 ...
 */
final class Version20201113084632 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE student ADD classroom_id INT DEFAULT NULL, ADD cin INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE student DROP classroom_id, DROP cin');
    }
}
